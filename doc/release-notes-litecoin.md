Favcoin Core version *0.15.1* is now available from:

  <https://download.favcoin.org/favcoin-0.15.1/>
...
A number of changes to the way Favcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 favorites per kB (0.00001 FAV). This is to prepare for dropping the minimum transaction fee to 0.1 favorites per kB (0.0001 FAV) in the next release.
