...
const char * const BITCOIN_CONF_FILENAME = "favcoin.conf";
const char * const BITCOIN_PID_FILENAME = "favcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Favcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Favcoin";
#else
    // Unix
    return pathRet / ".favcoin";
#endif
#endif
}
