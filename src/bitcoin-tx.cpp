...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s favcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  favcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded favcoin transaction") + "\n" +
              "  favcoin-tx [options] -create [commands]   " + _("Create hex-encoded favcoin transaction") + "\n" +
              "\n";
