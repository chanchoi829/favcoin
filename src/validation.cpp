...
#if defined(NDEBUG)
# error "Favcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Favcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FAV additional fees, %d delta bytes\n",
